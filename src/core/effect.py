...
def fire_n_smoke_1 (parent, store=None,
                    sclfact=1.0,
                    emradfact=1.0,
                    fcolor=rgba(255, 173, 104, 1.0),
                    fcolorend=rgba(255, 150, 104, 1.0),
                    ftcol=1.0,
...
def fire_n_smoke_2 (parent, store=None,
    ...
    if spos is not None:
        smoke = PolyBurn(
            ...
            emitradius=emitradius,
            offtang=0.0,
            texture="images/particles/smoke7-1.png",
            glowmap=pycv(py=rgba(255, 255, 255, 1.0), c=rgba(0, 0, 0, 0.1)),
            # color=pycv(py=rgba(77, 33, 0, 1.0), c=rgba(255, 109, 0, 1.0)),
            # endcolor=pycv(py=rgba(18, 17, 16, 1.0), c=rgba(255, 239, 230, 1.0)),
            color=pycv(py=rgba(77, 33, 0, 1.0), c=rgba(255, 109, 0, 1.0)),
...
def fire_n_smoke_3 (parent, store=None,
    ...
    if fpos1 is not None:
        fire1 = PolyBurn(
            ...
            # # # # offtang=[0.0, 0.33, 0.66],
            offtang=0.0,
            # # # # texture=["images/particles/explosion7-1.png", "images/particles/explosion7-2.png", "images/particles/explosion7-3.png"],
            texture="images/particles/explosion7-1.png",
            glowmap=rgba(255, 255, 255, 0.4),
            additive=True,

            obpos=fpos1,
            obcolor=(rgba(255, 173, 96, 1.0) * 16),
            obcolor2=None,
            ...
            color=rgba(255, 173, 96, 1.0),
            endcolor=rgba(255, 79, 25, 1.0),
            dirlit=False,
            alphaexp=2.0,
            tcol=0.8,
            maxpoly=pycv(py=500, c=2000),
    ...
    fire3 = PolyBurn(
        ...
        offtang=0.0,
        texture="images/particles/explosion7-2.png",
        glowmap=rgba(255, 255, 255, 0.4),
        additive=True,
        color=rgba(255, 173, 104, 1.0),
        endcolor=rgba(255, 150, 104, 1.0),
        dirlit=False,
        alphaexp=2.0,
        tcol=0.6,
        maxpoly=pycv(py=500, c=2000),
    ...
    fire4 = PolyBurn(
        ...
        offtang=0.0,
        texture="images/particles/explosion7-3.png",
        glowmap=rgba(255, 255, 255, 0.4),
        additive=True,
        color=rgba(255, 173, 96, 1.0),
        endcolor=rgba(255, 79, 25, 1.0),
    ...
    fire5 = PolyBurn(
        ...
        emitradius=1.0 * emradfact,
        offtang=0.0,
        texture="images/particles/explosion7-4.png",
        glowmap=rgba(255, 255, 255, 0.4),
        additive=True,
        color=rgba(255, 94, 15, 1.0),
        endcolor=rgba(255, 107, 56, 1.0),
        dirlit=False,
        alphaexp=2.0,
        tcol=0.8,
        maxpoly=pycv(py=500, c=2000),
    ...
    if spos1 is not None:
        smoke1 = PolyBurn(
            ...
            # # # # offtang=[0.0, 0.33, 0.66],
            offtang=0.0,
            # # # # texture=["images/particles/smoke7-1.png", "images/particles/smoke7-2.png", "images/particles/smoke7-3.png"],
            texture="images/particles/smoke7-1.png",
            glowmap=pycv(py=rgba(255, 255, 255, 1.0), c=rgba(0, 0, 0, 0.1)),
            #color=rgba(77, 33, 0, 1.0),#rgba(128, 55, 0, 1.0),
            #endcolor=rgba(31, 29, 28, 1.0),
